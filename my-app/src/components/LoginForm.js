        ...
        <form onSubmit={submitHandler}>
            <div className="form-inner">
                ...
                <div className="form-signup-group">
                    <h6>Or login with</h6>
                    <div className="form-signup-sites">
                        <div className="signup-bt" onClick={() => onSocialMediaSignin("Facebook")}>
                            <FacebookIcon className='signup-icon' fontSize='small' style={FacebookStyle} />
                            <span style={FacebookStyle}>Facebook</span>
                        </div>
                        <div className="signup-bt" onClick={() => onSocialMediaSignin("Google")}>
